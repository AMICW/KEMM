...
class ShipPlotConfig:
    ...
    start_marker_color: str = "#1d4ed8"
    goal_marker_color: str = "#16a34a"
    traffic_marker_color: str = "#dc2626"
    ...
    circular_obstacle_legend_color: str = "#111827"
    keep_out_legend_color: str = "#86efac"
    channel_boundary_legend_color: str = "#d1d5db"
    knee_color: str = "#b42318"
    panel_facecolor: str = "#f8fafc"
    legend_facecolor: str = "#ffffff"
    legend_edgecolor: str = "#cbd5e1"
    legend_alpha: float = 0.94
    card_facecolor: str = "#ffffff"
    card_edgecolor: str = "#cbd5e1"
    card_alpha: float = 0.92
    plotly_legend_bgcolor: str = "rgba(255,255,255,0.86)"
    command_color: str = "#7c3aed"
    limit_line_color: str = "#ef4444"
    yaw_rate_color: str = "#10b981"
    speed_color: str = "#f59e0b"
    projected_point_color: str = "#94a3b8"
    component_domain_color: str = "#0f766e"
    component_dcpa_color: str = "#7c3aed"
    component_obstacle_color: str = "#dc2626"
    component_environment_color: str = "#f59e0b"
    static_clearance_color: str = "#7c3aed"
    ship_distance_color: str = "#16a34a"
    zero_line_color: str = "#991b1b"
    dcpa_color: str = "#0f766e"
    tcpa_color: str = "#f97316"
    runtime_bar_color: str = "#64748b"
    knee_marker: str = "*"
    ...
    scalar_field_levels: int = 16
    scalar_field_floor_quantile: float = 0.18
    scalar_field_alpha: float = 0.28
    vector_field_alpha: float = 0.22
    ...
    dashboard_width_ratios: tuple[float, float, float] = (1.35, 1.35, 1.0)
    dashboard_height_ratios: tuple[float, float] = (1.0, 0.92)
